...
from .enums import OrderSide, OrderType, TradingStrategyType
...
class MomentumStrategy(TradingStrategy):
    ...
    async def generate_signals(
        self, market_data: Dict, ml_predictions: Dict
    ) -> List[Order]:
        ...
        for symbol in market_data.get("symbols", []):
            ...
            if current_position == 0:
                ...
                if current_position > 0:
                    ...
                    exit_signal = (
                        combined_signal < self.params["exit_threshold"]
                        or pnl_bps <= -self.params["stop_loss_bps"]
                        or pnl_bps >= self.params["take_profit_bps"]
                        or time_in_position > self.params["hold_time"]
                    )
